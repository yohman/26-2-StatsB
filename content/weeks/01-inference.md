...
title_ja: 推測統計学の基礎：推測統計学のプロセス / 確率の基礎
title_en: Fundamentals of Inferential Statistics: The Inferential Process / Foundations of Probability
formula: 0 ≤ Pr(A) ≤ 1
image: assets/images/week-01-population.png
prepare_en: Review the terms probability, population, and sample before class.
---

## Prepare

確率、母集団、標本という言葉を確認してから来てください。

## In class

- 推測統計学のプロセス、推定量・推定値、標本誤差 (inferential process, estimator/estimate, sampling error)
...
- [Yoh probability handout answers](other material/2025 yoh/03 推測統計学の基礎_1_推測統計学のプロセス/ch3_配布資料_ans.pdf) {answer}
